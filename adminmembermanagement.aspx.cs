...
namespace Elibrary_Project
{
    public partial class adminmembermanagement : System.Web.UI.Page
    {
        ...
        void deleteMemberByID()
        {
            if (checkIfMemberExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE FROM book_issue_tbl WHERE member_id='" + TextBox1.Text.Trim() + "'", con);
                    cmd.ExecuteNonQuery();
        ...
        //            cmd = new SqlCommand("DELETE from book_issue_tbl WHERE member_id='" + TextBox1.Text.Trim() + "'", con);
        //            cmd.ExecuteNonQuery();
        //            con.Close();
